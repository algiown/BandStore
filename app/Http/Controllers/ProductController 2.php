...
class ProductController extends Controller
{
    ...
    {   
		...
		setcookie('shopping_cart', $item_data, time()+(86400*30),"/");
		 ...
		 return redirect('/cart')->with('success', 'Prodak berhasil ditambahkan ke keranjang!');
		}
    }else{  
	    return redirect('/product')->with('failed', 'Gagal menambahkan ke keranjang, karena stok prodak terbatas!');
    }
}
}