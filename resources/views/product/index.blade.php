           ...
           <div class="row pt-3">
             ...
             <div class="col-md-6 my-auto">
              <div class="col-md-12 text-center text-md-start">
                ...
                <p><span>Nama : </span><?= $product['name']; ?></p>
                <p><span>Merk : </span><?= $product['brand']; ?></p>
                <p><span>Harga : </span>{{  'Rp. ' . number_format($product['price'],2,'.','.'); }}</p>
                <p><span>Kategori : </span><?= $product['type']; ?></p>
                ...
                <div class="row">
                  <div class="col-xs-6 text-center text-md-start">
                    ...
                    <form action="/product/{{ $product['id'] }}" method="post">
                      ...
                      <p>Jumlah : </p><input type="number" name="qty" class="inputForm w-50 mx-auto mx-md-0 d-block text-md-start text-center" 
											value="{{ $jumlah }}" min="1" max="<?= $product['qty'];?>" >
                      
                      <button type="submit" class="btn btn-dark btn-keranjang mt-2 mb-2">Tambah Ke Troli</button>
                    </form>
										<?php else: ?>
